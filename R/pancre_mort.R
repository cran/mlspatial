...
#'   \item{mortality}{Numeric. Mortality rate per 100,000 population.}
...
#' }
#'
#' @source Global Burden of Disease (GBD) 2021 estimates, https://vizhub.healthdata.org/gbd-results/
#' @usage data(pancre_mort)
#' @keywords datasets
#'
"pancre_mort"
